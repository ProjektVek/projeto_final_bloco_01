...
public class Cores {
	...
	// Esquema de Cores
	public static final String corBackground = ANSI_BLACK_BACKGROUND;
	public static final String corMoldura = TEXT_PURPLE_BOLD_BRIGHT;
	public static final String corTextoNormal = TEXT_WHITE_BOLD_BRIGHT;
	public static final String corTextoDestaque = TEXT_GREEN_BOLD_BRIGHT;
